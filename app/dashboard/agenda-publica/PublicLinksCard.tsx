...
/**
 * Card de la sección "Agenda en línea": genera y administra los enlaces públicos por médico
 * (+sede) con los que los pacientes agendan solos desde /agendar/[token]. Un solo enlace
 * activo por médico+sede; generar uno nuevo invalida el anterior.
 * (Antes vivía como modal en la agenda — BookingLinkModal — movido aquí como sección.)
 */
export default function PublicLinksCard({ doctors, locations }: PublicLinksCardProps) {
  ...
  return (
    <div className="card">
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
        ...
        <h3 style={{ margin: 0, fontSize: '1.1rem' }}>Enlaces públicos</h3>
      </div>

      <p style={{ margin: '0 0 1rem', fontSize: '0.85rem', color: 'var(--text-muted)', lineHeight: 1.5 }}>
        Comparte el enlace de cada médico con tus pacientes para que agenden su cita solos
        (citas de 1 hora, según su horario de abajo). Cada cita agendada queda
      ...
      <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', alignItems: 'flex-end', marginBottom: '1.25rem' }}>
        <div className="form-group" style={{ marginBottom: 0, flex: 1, minWidth: '180px', maxWidth: '300px' }}>
        ...
        {activeLocations.length > 0 && (
          <div className="form-group" style={{ marginBottom: 0, flex: 1, minWidth: '160px', maxWidth: '280px' }}>
